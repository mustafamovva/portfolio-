...
export default function Hero() {
  return (
    <section className="relative mx-auto max-w-[1280px] overflow-hidden px-[6vw] pb-[110px] pt-24">
      {/* Accent grid */}
      <div
        aria-hidden
      ...
      <div className="relative z-[2] grid min-h-[560px] grid-cols-1 items-center gap-12 md:grid-cols-[1.05fr_0.95fr]">
